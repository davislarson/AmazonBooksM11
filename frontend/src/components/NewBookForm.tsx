...
const NewBookForm = ({ onSuccess, onCancel }: NewBookFormProps) => {
  const [formData, setFormData] = useState<Book>({
    bookID: 0, // This will be set by the backend when the book is added
    title: '',
    author: '',
    publisher: '',
    isbn: '',
    classification: '', // e.g. Fiction, Non-Fiction, etc.
    category: '', // e.g. Science, History, etc.
    pageCount: 0, // Number of pages in the book
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-grid">
        ...
        <label>
          Page Count:
          <input type="text" name="pageCount" value={formData.pageCount} onChange={handleChange} />
        </label>
        <label>
          Price:
